<template>
    <div id="settings">
        <v-row row>
            ...
            <v-col xs6>
                <div>
                    <v-btn floating small dark primary class="mt-3" @click.native.stop="loadForm"
                           v-if="selectForm.selected.id">
...
//                let index = lodash.findKey(this.settingsForm[name].fields, (o)=>o.position==position)
//                this.settingsForm[name].fields.splice(index,1)
//                this.settingsForm[name].btn_remove = lodash.pull(this.settingsForm[name].btn_remove, position)
      }
    }
  }
</script>
